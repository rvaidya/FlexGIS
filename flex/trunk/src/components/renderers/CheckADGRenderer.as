...
package components.renderers
{
	...
	public class CheckADGRenderer extends AdvancedDataGridGroupItemRenderer
	{
        ...
        private var inner:String 	= "assets/img/inner.png";
		protected var myCheckBox:CheckBox;
		static private var STATE_SCHRODINGER:String = "schrodinger";
		static private var STATE_CHECKED:String = "true";
		static private var STATE_UNCHECKED:String = "false";
		...
		private function getState(adg:AdvancedDataGrid, parent:Object):String
		{
			...
			if (parent != null)
			{
				...
				while (!cursor.afterLast)
				{
					if (cursor.current.@enabled == STATE_CHECKED)
					{
						noChecks++;
					}
					else if (cursor.current.@enabled == STATE_UNCHECKED)
					{
						noUnChecks++
					}
					else
		...
		private function checkBoxToggleHandler(event:MouseEvent):void
		{
			if (data)
			{
				...
				Application.application.layerList.dispatchEvent(new Event("LayerStateChangeEvent"));
			}
		}
		...
		override public function set data(value:Object):void
		{
			...
			setCheckState (myCheckBox, value, value.@enabled);
	   ...
	   override protected function updateDisplayList(unscaledWidth:Number, unscaledHeight:Number):void
	   {
	        ...
	        if(super.data)
	        {
			    ...
			    if (data.@enabled == STATE_SCHRODINGER)
			    {
